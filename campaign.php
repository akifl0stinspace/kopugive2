...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container">
            ...
            <div class="ms-auto">
                <?php if (isLoggedIn()): ?>
                    <a href="<?= isAdmin() ? 'admin/dashboard.php' : 'donor/dashboard.php' ?>" class="btn btn-outline-primary">
    ...
    <?php if ($campaign['banner_image']): ?>
        <img src="<?= htmlspecialchars($campaign['banner_image']) ?>" class="w-100 campaign-banner" alt="Campaign Banner" style="height: 300px; object-fit: cover;">
    <?php else: ?>
        <div class="campaign-banner d-flex align-items-center justify-content-center text-white bg-secondary" style="height: 300px;">
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <?php foreach ($updates as $update): ?>
                                ...
                                <?php if (!$update !== end($updates)): ?><hr><?php endif; ?>
                            <?php endforeach; ?>
                        </div>
                    </div>
                <?php endif; ?>
